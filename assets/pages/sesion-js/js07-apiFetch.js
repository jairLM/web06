console.log('JS-07 apiFetch');
/**
 * API: Application programming interface
 *  Permite la comunicación entre 2 aplicaciones de software a través
 * La API fetch nos ayuda a acceder y mainpular peticiones HTTP
 * Peticiones HTTP: (DELETE, GET, POST, PUT)
 * 
 * sintaxis:
 *  fetch( resource, opcion )
 */
